      ...
      <>
        ...
        <div className="min-h-[60vh] flex items-center justify-center">
          ...
          <div className="text-center">
            ...
            <div className="w-12 h-12 mx-auto border-4 border-green-600 border-t-transparent rounded-full animate-spin" />
        ...
        <section className="py-10 md:py-16">
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 sm:p-8 md:p-10">
              ...
              {content ? (
                <div className="text-gray-700 leading-8 whitespace-pre-line break-words">
                  {content}
                </div>
              ) : (
