      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-300 focus:border-green-500 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:outline-none"
          />
...
<label className="flex items-center justify-between border rounded-xl px-4 py-3 cursor-pointer">
  ...
  <input
    type="checkbox"
    checked={
      homepage.homepageSections?.flashDeals ?? true
    }
    onChange={(e) =>
      handleSectionChange(
        "flashDeals",
