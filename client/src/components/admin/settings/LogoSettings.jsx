    ...
    <div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-green-300 hover:border-green-600 rounded-2xl p-6 transition">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-gray-300 hover:border-blue-500 rounded-2xl p-6 transition-all duration-300">
              ...
              <div className="flex flex-col items-center">
                ...
                <input
                 ...
                 className="mt-5 w-full text-sm text-gray-600 file:mr-4 file:rounded-lg file:border-0 file:bg-green-600 file:px-4 file:py-2 file:text-white hover:file:bg-green-700"
                />
      ...
      <div className="mt-10 flex justify-end">
        ...
        <button
          ...
          onClick={onSave}
          disabled={saving}
          className="inline-flex items-center gap-3 bg-green-600 hover:bg-green-700 disabled:bg-green-400 disabled:cursor-not-allowed text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300"
        >
          {saving ? (
            <>
              <svg
